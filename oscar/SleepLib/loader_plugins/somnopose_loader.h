...
class SomnoposeLoader : public MachineLoader
{
  public:
    ...
    virtual MachineInfo newInfo() {
        return MachineInfo(MT_POSITION, 0, somnopose_class_name, QObject::tr("Somnopose"), QObject::tr("Somnopose"), QString(), QString(), QObject::tr("Somnopose Software"), QDateTime::currentDateTime(), somnopose_data_version);
    }
