...
qint64 SessionChannelsRepository::create(const SessionChannelData& data)
{
    ...
    if (!query.exec()) {
        ...
        DatabaseManager::instance().checkQueryError("SessionChannelsRepository::create", query);
        return -1;
    }
...
bool SessionChannelsRepository::update(const SessionChannelData& data)
{
    ...
    if (!query.exec()) {
        ...
        DatabaseManager::instance().checkQueryError("SessionChannelsRepository::update", query);
        return false;
    }
...
QList<SessionChannelData> SessionChannelsRepository::findBySession(qint64 sessionId)
{
    ...
    if (!query.exec()) {
        ...
        DatabaseManager::instance().checkQueryError("SessionChannelsRepository::findBySession", query);
        return result;
    }
...
SessionChannelData SessionChannelsRepository::findByChannel(qint64 sessionId, int channelId)
{
    ...
    if (!query.exec()) {
        ...
        DatabaseManager::instance().checkQueryError("SessionChannelsRepository::findByChannel", query);
        return data;
    }
...
bool SessionChannelsRepository::saveBatch(qint64 sessionId, qint64 profileId, const QList<SessionChannelData>& channels)
{
    ...
    for (const SessionChannelData& data : channels) {
        ...
        if (!query.exec()) {
            ...
            DatabaseManager::instance().checkQueryError("SessionChannelsRepository::saveBatch", query);
            return false;
        }
    }
                                                  ...
                                                  QHash<int, qint64>& idMap)
{
    ...
    for (const SessionChannelData& data : channels) {
        ...
        if (!query.exec()) {
            ...
            DatabaseManager::instance().checkQueryError("SessionChannelsRepository::saveBatchWithIds", query);
            return false;
        }
...
bool SessionChannelsRepository::remove(qint64 id)
{
    ...
    if (!query.exec()) {
        ...
        DatabaseManager::instance().checkQueryError("SessionChannelsRepository::remove", query);
        return false;
    }
...
bool SessionChannelsRepository::removeBySession(qint64 sessionId)
{
    ...
    if (!query.exec()) {
        ...
        DatabaseManager::instance().checkQueryError("SessionChannelsRepository::removeBySession", query);
        return false;
    }
...
int SessionChannelsRepository::countBySession(qint64 sessionId)
{
    ...
    if (!query.exec()) {
        ...
        DatabaseManager::instance().checkQueryError("SessionChannelsRepository::countBySession", query);
        return 0;
    }
