...
:::     buildall-qt6.bat 6.10.2
::: This batch file confirmed to work with Qt 6.9.3 and 6.10.2
set	qtVersion=%1
...
if not exist %basedir%\%dirname%\nul mkdir %basedir%\%dirname%
cd %basedir%\%dirname%
...
%qtpath%\Tools\mingw1310_64\bin\mingw32-make.exe -j%CPUS%  || goto :makefail
::: timer /s /nologo
  
::: timer /nologo
::: call ..\Building\Windows\deploy.bat skipInstall
::: timer /s /nologo
